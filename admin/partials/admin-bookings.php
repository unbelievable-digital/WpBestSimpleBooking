		...
		<div class="unbsb-card-body">
			<form method="get" class="unbsb-filter-form">
				...
				<div class="unbsb-filter-row">
					...
					<div class="unbsb-filter-field">
						<label for="search"><?php esc_html_e( 'Search', 'unbelievable-salon-booking' ); ?></label>
						<input type="text" name="search" id="search" value="<?php echo esc_attr( $search ); ?>" placeholder="<?php esc_attr_e( 'Customer name or email...', 'unbelievable-salon-booking' ); ?>">
					</div>
							...
							<tr data-id="<?php echo esc_attr( $booking->id ); ?>">
								...
								<td>
									<div class="unbsb-actions">
										...
										<?php endif; ?>
										<button type="button" class="unbsb-btn unbsb-btn-sm unbsb-btn-icon unbsb-edit-booking" data-id="<?php echo esc_attr( $booking->id ); ?>" title="<?php esc_attr_e( 'Edit', 'unbelievable-salon-booking' ); ?>">
									...
									<div class="unbsb-form-group">
										...
										<select id="edit-booking-service" name="service_id" required>
											...
											<?php foreach ( $services as $service ) : ?>
												<option value="<?php echo esc_attr( $service->id ); ?>" data-duration="<?php echo esc_attr( $service->duration ); ?>" data-price="<?php echo esc_attr( $service->price ); ?>"><?php echo esc_html( $service->name ); ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
